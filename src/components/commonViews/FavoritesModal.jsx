  ...
  return (
    ...
    >
        <div
            ...
            className={`bg-white rounded-lg shadow-lg w-3/4 max-w-5xl p-6 overflow-y-auto transition-transform ${
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 overflow-hidden">
                {/* Gallery Favorites */}
                <div className="bg-gray-100 p-4 rounded-lg shadow overflow-y-auto">
